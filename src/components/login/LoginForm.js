...
class LoginForm extends Component {
    ...
    validate = () => {
        ...
        if (this.state.password.length < 4) {
            inputError = true;
            errors.passwordError = "You password must contain between 4 and 60 characters"
        }
                ...
                <div className="form-container">
                    <from>
                        ...
                        <div className="input-container">
                            <input
                                className={
                                    this.state.emailError ? 'input-error input-empty' : 'input-empty'
                                }
                                type="email"
                        ...
                        <div className="input-container">
                            <input
                                className={
                                    this.state.passwordError ? 'input-error input-empty' : 'input-empty'
                                }
                                type="password"
